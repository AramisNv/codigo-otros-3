...
for (let i = 0; i < productos.length; i++) {
  ...
  var pCreado = document.createElement("p");//ti = pCreado
...
botonDeFiltro.onclick = function() {
  ...
  for (let i = 0; i < productosFiltrados.length; i++) {
    ...
    var pCreado = document.createElement("p");
    pCreado.classList.add("titulo");
...
//En conclusion cambie los nombres de variables y constantes para no confundirme y darle más sentido, tambien se agrego ; al termino de cada (). Asi como algunos detalles en html